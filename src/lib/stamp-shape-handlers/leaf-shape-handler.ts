...
import { distributeHandlerFromParams, IGridDistributeParams } from '../distribute';
...
export class LeafShapeHandler extends BaseHandler {
  handle(params: ILeafShapeParams, context: IShapeContext): void {
    ...
    if (params.distribute?.type === 'grid') {
      (params.distribute as IGridDistributeParams).negateOffsetX = true;
    }
