...
SPLODER.PlayerCamera = function (fov, aspect, near, far) {
    ...
    this.translateX = function (distance, keepLevel) {

        var oldY = cameraDummy.position.y;
        cameraDummy.translateX(distance);
        if (keepLevel) cameraDummy.position.y = oldY;
    ...
    this.translateZ = function (distance, keepLevel) {
...
SPLODER.PlayerCamera.prototype = Object.create(THREE.PerspectiveCamera.prototype);
SPLODER.PlayerCamera.prototype.constructor = SPLODER.PlayerCamera;
