...
EARCUT.Triangulator = function () {

    this.triangulate_polygon = function (points, returnIndices) {
        ...
        var res = earcut(rings, returnIndices);
        return res;

    }

    var earcut = function (points, returnIndices) {
    ...
    var linkedList = function (points, clockwise) {
        var sum = 0,
            len = points.length,
            i, j, p1, p2, last;
    ...
    var earcutLinked = function (ear, triangles, minX, minY, size, pass) {
        if (!ear) return;
    ...
    var addIndexedVertex = function (triangles, node) {
    ...
    var isEar = function (ear, minX, minY, size) {
    ...
    var cureLocalIntersections = function (start, triangles) {
    ...
    var splitEarcut = function (start, triangles, minX, minY, size) {
    ...
    var eliminateHoles = function (points, outerNode) {
    ...
    var eliminateHole = function (holeNode, outerNode) {
    ...
    var findHoleBridge = function (holeNode, outerNode) {
        var node = outerNode,
            p = holeNode.p,
            px = p[0],
            py = p[1],
    ...
    // interlink polygon nodes in z-order
    var indexCurve = function (start, minX, minY, size) {
        var node = start;
    ...
    var zOrder = function (x, y, minX, minY, size) {
    ...
    var intersectsPolygon = function (start, a, b) {
        var node = start;
        do {
            var p1 = node.p,
                p2 = node.next.p;
    ...
    var middleInside = function (start, a, b) {
        var node = start,
            inside = false,
            px = (a[0] + b[0]) / 2,
            py = (a[1] + b[1]) / 2;
    ...
    var insertNode = function (point, last) {
